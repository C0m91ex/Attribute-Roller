...
class Player {
    constructor(characterName = 'Levi') {
...
const player02 = new Player('Mikasa');
player02.rollAttributes();
player02.printPlayer();

// Fisher-Yates algoritm for randomly sorting an array
// from: https://dev.to/codebubb/how-to-shuffle-an-array-in-javascript-2ikj
// adapted to JS and recofigured to return a new (non-mutated) array
